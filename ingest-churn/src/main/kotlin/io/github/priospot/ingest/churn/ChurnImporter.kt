...
data class ChurnOptions(val days: Int = 30, val churnLog: Path? = null, val writeGitLogTo: Path? = null)

data class ChurnStats(val linesAdded: Int, val linesRemoved: Int, val timesChanged: Int) {
